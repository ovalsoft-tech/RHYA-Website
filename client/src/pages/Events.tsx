...
// Fallback data in case Sanity fetch fails or returns empty
const fallbackEvents: Event[] = [
  {
    ...
    image: {
      asset: {
        _ref: "image-123" // Mock ref, won't be used with urlFor in fallback
      },
      fallbackUrl: "https://images.unsplash.com/photo-1544531586-fde5298cdd40?q=80&w=2670&auto=format&fit=crop"
    },
  ...
  },
  {
    ...
    image: {
      ...
      fallbackUrl: "https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=2670&auto=format&fit=crop"
    },
  ...
  },
  {
    ...
    image: {
      ...
      fallbackUrl: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?q=80&w=2670&auto=format&fit=crop"
    },
  ...
  },
  {
    ...
    image: {
      ...
      fallbackUrl: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=2670&auto=format&fit=crop"
    },
    ...
    const fetchEvents = async () => {
      try {
        ...
        if (data && data.length > 0) {
          ...
          // Use fallback data if no events found in CMS
          ...
          <div className="container mx-auto px-4">
            {loading ? (
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                {events.map((event) => (
                  <div key={event._id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col md:flex-row h-full">
